...
+
Pivotal Web Services offers the cleardb service in its marketplace.  If working in a different Pivotal Cloud Foundry environment, you are likely to have p-mysql instead.
+
