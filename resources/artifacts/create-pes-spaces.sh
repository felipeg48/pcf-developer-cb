#!/bin/bash
#
# This script takes in a list of emails (newline seperated) and builds out cf spaces in the
# Pivotal-Education-Students org.  Each email address will be used as a space name.
